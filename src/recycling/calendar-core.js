...
const requiredTranslationPaths = [
  ...
  "page.title",
  "page.intro",
  "page.collectionTimeLabel",
  "page.collectionTimeNotice",
  "page.audience",
  "calendar.title",
  ...
  "calendar.nextCollectionInstruction",
  "calendar.putOutInstruction",
...
const requiredTemplateTokens = {
  ...
  "calendar.nextCollectionInstruction": ["previousDate"],
  "calendar.putOutInstruction": ["previousWeekday"],
